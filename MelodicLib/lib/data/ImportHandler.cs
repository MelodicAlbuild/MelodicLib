...
namespace MelodicLib.lib.data
{
    public class ImportHandler
    {
        ...
        {
            MelodicLog.Log("[Import Handler]: Import Started");
            Import();
            MelodicLog.Log("[Import Handler]: Import Complete");
        }
        public static Rootobject imports;
        private static readonly string path = System.Environment.GetEnvironmentVariable("USERPROFILE") + "/appdata/locallow/volcanoid/volcanoids/MelodicMods/" + MelodicLib.modName + "/data/data.json";
        private void Import()
        {
